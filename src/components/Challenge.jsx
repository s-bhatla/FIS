...
const Challenge = () => {
  return (
    <div>
        ...
        <div class="text-white sm:pl-[4rem] sm:pr-[1rem] px-[1rem] text-3xl max-w-[100vw] font-extrabold mt-[3rem] py-4 bg-gradient-to-r from-sky-600 via-green-500 to-green-400">THE CHALLENGE</div>
        </div>
        <div className="mt-6">
