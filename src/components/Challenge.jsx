    ...
    <div id="challenge">
      ...
      <div className="mt-8 mx-auto">
        <div className="sm:max-w-[70vw] mx-auto px-4 text-[16px] text-center mb-[2rem] text-white">
          ...
          include a theme-specific pitch deck that defined problem statement and
          how the proposed solution is offered. The solution could be either a
          standalone or integrated with FIS APIs. Participants can also suggest
          new APIs that may help to enhance the solution further.
        </div>
