...
const Hack = () => {
  return (
    <div class="">
        ...
        <div class="text-white sm:text-3xl max-w-[100vw] font-extrabold mt-[3rem] py-4 bg-gradient-to-r from-sky-600 via-green-500 to-green-400">THIS YEAR WE HACK FOR</div>
        </div>
