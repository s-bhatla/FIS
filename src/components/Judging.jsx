...
const Judging = () => {
  return (
    <div>
        ...
        <div className="heading pl-[4rem] text-white text-3xl py-4 font-extrabold mt-[3rem] bg-gradient-to-r from-sky-600 via-green-500 to-green-400">WHAT'S THE JUDGING CRITERA ?</div>
        </div>
