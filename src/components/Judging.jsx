  ...
  return (
    <div>
      <div class="h-[5rem] w-max max-w-[100vw] mb-[4rem]">
        <div className="font-titilium sm:pl-[4rem] sm:pr-[1rem] px-[1rem] text-white text-4xl py-4 font-extrabold mt-[3rem] bg-gradient-to-r from-sky-600 via-green-500 to-green-400">
