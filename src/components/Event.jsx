...
const Event = () => {
  return (
    ...
    <div class="text-white text-3xl font-extrabold mt-[3rem] py-4 bg-gradient-to-r from-sky-600 via-green-500 to-green-400">ABOUT THIS INNOVATEIN48 EVENT</div>
    </div>
    <div class="flex flex-row  flex-wrap mt-[4rem] justify-evenly ml-[4rem]">
