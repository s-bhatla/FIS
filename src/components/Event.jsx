...
const Event = () => {
  return (
    ...
    <div class="sm:pl-[4rem] sm:pr-[1rem] px-[1rem] text-white text-3xl font-extrabold mt-[3rem] py-4 bg-gradient-to-r from-sky-600 via-green-500 to-green-400">ABOUT THIS INNOVATEIN48 EVENT</div>
    </div>
